...
class TextToSpeechProcessor:
    ...
    def convert_text_to_speech(self):
        ...
        for index, item in enumerate(self.data):
            ...
            if paragraph:
                # Convert the paragraph to speech
                tts = gTTS(paragraph, lang=self.lang)

                # Save the audio file in the 'audio' folder with a unique name
                audio_filename = os.path.join(self.audio_folder, f"audio_{index + 1}.mp3")
