...
PROMPT = """
            ...
            if a paraphraph has More than 170 character including white spaces then split it into more or less equal sub paragraphs keeping the context of the text
            The sub paragraphs must not be longer than 170 character including white spaces
            when splitting the paraphraph into sub paragraphs the sub paragraphs should be ordered by length while keeping the original order of the text
