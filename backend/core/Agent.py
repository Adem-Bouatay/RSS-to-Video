...
PROMPT = """
            ...
            the paraphraphs gonna be read like an article in news with voice so make sure it doesnt involve something like 'for more information click on link' or 'download full details...' etc
            The response should be formatted as follows:
            - if a paraphraph has More than 34 word including white spaces then split it into more or less equal sub paragraphs
                    ...
                    article:[
                        {
                            ...
                            "Pour toutes celles qui doivent cumuler bureau et chaleurs extrêmes, la question du look à arborer face à de telles températures est sans doute survenue à plusieurs reprises.",
                            "Comment rester chic et bien habillée même quand le thermomètre affiche 30+ degrés ?",
                            "La réponse prend la forme d'une petite robe courte en lin repérée dans la nouvelle collection &Other Stories."
                            ],
                        ...
                        },
                        {
                            ...
                            "Mais la forme que l'on préfère pour un look de bureau quand il fait chaud est sans conteste la robe courte en lin à fines bretelles et de coupe trapèze.",
                            "Cette forme évasée a l'avantage de convenir à toutes les morphologies, mais aussi de laisser l'air circuler.",
                            "Un atout de taille en période de fortes chaleurs."
                            ],
                            "image": "https://cache.cosmopolitan.fr/data/photo/w680_ci/6v/robe-quand-il-fait-chaud-1.jpg"
                        },
                        {
                            "text": [
                            "Pour vaincre les fortes chaleurs sans perdre un degré de style, la clé est d'éviter l'accumulation.",
                            "Que cela soit au niveau des vêtements ou des accessoires.",
                            "On s'en tient au strict minimum et pour cela, on mise sur des pièces mode qui se suffisent à elles-mêmes.",
                            "Outre la petite robe trapèze aussi à l'aise en journée qu'en soirée, on peut aussi se tourner vers le pantalon large agréable à porter ou encore la jupe portefeuille, flatteuse pour la silhouette."
                            ],
